...
namespace Oqtacore.Rrm.Api.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        private string GenerateJwtToken(AspNetUser user)
        {
            ...
            if (string.IsNullOrEmpty(jwtKey) || jwtKey == "YOUR_JWT_SECRET_KEY_HERE")
            {
                throw new InvalidOperationException("JWT key is not configured properly. Please set a valid JWT key in configuration.");
            }
