    ...
    public class ExceptionMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext context, ApplicationContext dbContext)
        {
            try
            {
                ...
                {
                    await LogErrorAsync(context, dbContext, null);
                }
            }
            catch (Exception ex)
            {
                ...
                if(ex.InnerException != null)
                    _logger.LogError(ex.InnerException, "An unhandled exception has occurred.");
        ...
        private async Task LogErrorAsync(HttpContext context, ApplicationContext dbContext, Exception? exception)
        {
