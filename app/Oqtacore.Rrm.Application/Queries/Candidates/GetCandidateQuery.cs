...
{
    public class GetCandidateQuery : SingleQuery<GetCandidateQueryResult>
    {
        public int Id { get; set; }
    }
    public class GetCandidateQueryResult : SingleQueryResult<GetCandidateQueryResultItem>
    {
    }
    public class GetCandidateQueryResultItem
    {
        public int Id { get; set; }
