...
{
    public class GetVacancyListQuery : ListQuery<GetVacancyListQueryResult>
    {
    }
    public class GetVacancyListQueryResult : ListQueryResult<GetVacancyListQueryResultItem>
    {
    }
    public class GetVacancyListQueryResultItem
    {
